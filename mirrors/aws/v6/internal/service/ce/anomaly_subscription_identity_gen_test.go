...
func TestAccCEAnomalySubscription_Identity_Basic(t *testing.T) {
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Step 1: Setup
			{
				ConfigDirectory: config.StaticDirectory("testdata/AnomalySubscription/basic/"),
...
func TestAccCEAnomalySubscription_Identity_ExistingResource(t *testing.T) {
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ConfigDirectory: config.StaticDirectory("testdata/AnomalySubscription/basic_v5.100.0/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
					"email_address": config.StringVariable(email_address),
				},
			...
			{
				ConfigDirectory: config.StaticDirectory("testdata/AnomalySubscription/basic_v6.0.0/"),
				ConfigVariables: config.Variables{
					acctest.CtRName: config.StringVariable(rName),
					"email_address": config.StringVariable(email_address),
				},
