...
import (
	...
	acctestgen "github.com/blampe/patches/mirrors/aws/v5/internal/acctest/generate"
	"github.com/blampe/patches/mirrors/aws/v5/internal/generate/common"
	tfmaps "github.com/blampe/patches/mirrors/aws/v5/internal/maps"
	"github.com/blampe/patches/mirrors/aws/v5/names/data"
	namesgen "github.com/blampe/patches/mirrors/aws/v5/names/generate"
)
				...
				if attr, ok := args.Keyword["checkDestroyNoop"]; ok {
					if b, err := strconv.ParseBool(attr); err != nil {
						...
						d.GoImports = append(d.GoImports,
							goImport{
								Path: "github.com/blampe/patches/mirrors/aws/v5/internal/acctest",
							},
						)
					}
				}
