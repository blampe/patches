...
import (
	...
	"github.com/blampe/patches/mirrors/aws/v6/internal/generate/common"
	"github.com/blampe/patches/mirrors/aws/v6/internal/generate/tests"
	tfmaps "github.com/blampe/patches/mirrors/aws/v6/internal/maps"
	"github.com/blampe/patches/mirrors/aws/v6/names/data"
	namesgen "github.com/blampe/patches/mirrors/aws/v6/names/generate"
)
	...
	if tlsKey {
		if len(tlsKeyCN) == 0 {
			...
			d.GoImports = append(d.GoImports,
				common.GoImport{
					Path: "github.com/blampe/patches/mirrors/aws/v6/internal/acctest",
				},
			)
		}
