...
import (
	...
	tfkinesis "github.com/blampe/patches/mirrors/aws/v5/internal/service/kinesis"
	"github.com/blampe/patches/mirrors/aws/v5/names"
)

func testResourceStreamStateDataV0() map[string]any {
	return map[string]any{
		...
		names.AttrTags:            map[string]any{acctest.CtKey1: acctest.CtValue1},
	}
}

func testResourceStreamStateDataV1() map[string]any {
