...
import (
	...
	tfapigateway "github.com/blampe/patches/mirrors/aws/v6/internal/service/apigateway"
...
// Reference: https://github.com/blampe/patches/mirrors/aws/v6/issues/5690
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckMethodSettingsExists(ctx, resourceName),
					acctest.CheckSDKResourceDisappears(ctx, t, tfapigateway.ResourceMethodSettings(), resourceName),
				),
