...
func testAccConfigServiceAggregateAuthorization_tagsSerial(t *testing.T) {
	t.Helper()
...
func testAccConfigServiceAggregateAuthorization_tags(t *testing.T) {
	...
	acctest.Test(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ConfigDirectory: config.StaticDirectory("testdata/AggregateAuthorization/tags/"),
...
func testAccConfigServiceAggregateAuthorization_tags_DefaultTags_providerOnly(t *testing.T) {
	...
	acctest.Test(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
				ConfigDirectory:          config.StaticDirectory("testdata/AggregateAuthorization/tags_defaults/"),
				ConfigVariables: config.Variables{
...
func testAccConfigServiceAggregateAuthorization_tags_ComputedTag_OnCreate(t *testing.T) {
	...
	acctest.Test(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
				ConfigDirectory:          config.StaticDirectory("testdata/AggregateAuthorization/tagsComputed1/"),
				ConfigVariables: config.Variables{
...
func testAccConfigServiceAggregateAuthorization_tags_ComputedTag_OnUpdate_Add(t *testing.T) {
	...
	acctest.Test(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
				ConfigDirectory:          config.StaticDirectory("testdata/AggregateAuthorization/tagsComputed2/"),
				ConfigVariables: config.Variables{
					"unknownTagKey": config.StringVariable("computedkey1"),
...
func testAccConfigServiceAggregateAuthorization_tags_IgnoreTags_Overlap_DefaultTag(t *testing.T) {
	...
	acctest.Test(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
				ConfigDirectory:          config.StaticDirectory("testdata/AggregateAuthorization/tags_ignore/"),
				ConfigVariables: config.Variables{
					acctest.CtProviderTags: config.MapVariable(map[string]config.Variable{
						acctest.CtProviderKey1: config.StringVariable(acctest.CtProviderValue1),
					}),
