...
func testAccAppFabricAppBundle_Identity_Basic(t *testing.T) {
	...
	acctest.Test(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Step 1: Setup
			{
				ConfigDirectory: config.StaticDirectory("testdata/AppBundle/basic/"),
...
func testAccAppFabricAppBundle_Identity_RegionOverride(t *testing.T) {
	...
	acctest.Test(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Step 1: Setup
			{
				ConfigDirectory: config.StaticDirectory("testdata/AppBundle/region_override/"),
				ConfigVariables: config.Variables{
...
func testAccAppFabricAppBundle_Identity_ExistingResource(t *testing.T) {
	...
	acctest.Test(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ConfigDirectory: config.StaticDirectory("testdata/AppBundle/basic_v5.100.0/"),
				ConfigVariables: config.Variables{},
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckAppBundleExists(ctx, resourceName, &v),
				),
			...
			{
				ConfigDirectory: config.StaticDirectory("testdata/AppBundle/basic_v6.0.0/"),
				ConfigVariables: config.Variables{},
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckAppBundleExists(ctx, resourceName, &v),
				),
