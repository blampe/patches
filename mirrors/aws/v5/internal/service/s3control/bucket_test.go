...
import (
	...
	tfs3control "github.com/blampe/patches/mirrors/aws/v5/internal/service/s3control"
...
func TestAccS3ControlBucket_tags(t *testing.T) {
	acctest.Skip(t, "S3 Control Bucket resource tagging requires additional eventual consistency handling, see also: https://github.com/blampe/patches/mirrors/aws/v5/issues/15572")
	ctx := acctest.Context(t)
