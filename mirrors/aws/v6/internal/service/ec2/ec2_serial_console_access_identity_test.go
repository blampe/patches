...
func testAccEC2SerialConsoleAccess_IdentitySerial(t *testing.T) {
	...
	testCases := map[string]func(t *testing.T){
		...
		"RegionOverride":            testAccEC2SerialConsoleAccess_Identity_RegionOverride,
		"Upgrade":                   testAccEC2SerialConsoleAccess_Identity_Upgrade,
		"UpgradeNoRefresh":          testAccEC2SerialConsoleAccess_Identity_Upgrade_NoRefresh,
	}
...
func testAccEC2SerialConsoleAccess_Identity_RegionOverride(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.Test(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Step 1: Setup
			{
				ConfigDirectory: config.StaticDirectory("testdata/SerialConsoleAccess/region_override/"),
				ConfigVariables: config.Variables{
...
func testAccEC2SerialConsoleAccess_Identity_ExistingResource(t *testing.T) {
	...
	acctest.Test(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ConfigDirectory: config.StaticDirectory("testdata/SerialConsoleAccess/basic_v5.100.0/"),
				ConfigVariables: config.Variables{},
				ConfigStateChecks: []statecheck.StateCheck{
			...
			{
				ConfigDirectory: config.StaticDirectory("testdata/SerialConsoleAccess/basic_v6.0.0/"),
				ConfigVariables: config.Variables{},
...
func testAccEC2SerialConsoleAccess_Identity_ExistingResource_NoRefresh_NoChange(t *testing.T) {
	ctx := acctest.Context(t)
...
// Resource Identity version 1 was added in version 6.21.0
func testAccEC2SerialConsoleAccess_Identity_Upgrade(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.Test(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ConfigDirectory: config.StaticDirectory("testdata/SerialConsoleAccess/basic_v6.20.0/"),
				ConfigVariables: config.Variables{},
				ConfigStateChecks: []statecheck.StateCheck{
...
// Resource Identity version 1 was added in version 6.21.0
func testAccEC2SerialConsoleAccess_Identity_Upgrade_NoRefresh(t *testing.T) {
	ctx := acctest.Context(t)
