...
import (
	...
	tfapprunner "github.com/blampe/patches/mirrors/aws/v6/internal/service/apprunner"
...
// Reference: https://github.com/blampe/patches/mirrors/aws/v6/issues/19469
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckServiceExists(ctx, resourceName),
					acctest.CheckSDKResourceDisappears(ctx, t, tfapprunner.ResourceService(), resourceName),
				),
