...
func TestAccCodeBuildResourcePolicy_Identity_Basic(t *testing.T) {
	ctx := acctest.Context(t)

	var v codebuild.GetResourcePolicyOutput
...
func TestAccCodeBuildResourcePolicy_Identity_RegionOverride(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccCodeBuildResourcePolicy_Identity_ExistingResource_NoRefresh_NoChange(t *testing.T) {
	ctx := acctest.Context(t)
