...
func TestAccNetworkManagerDevice_tags(t *testing.T) {
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ConfigDirectory: config.StaticDirectory("testdata/Device/tags/"),
...
func TestAccNetworkManagerDevice_tags_null(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccNetworkManagerDevice_tags_EmptyMap(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccNetworkManagerDevice_tags_AddOnUpdate(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccNetworkManagerDevice_tags_EmptyTag_OnCreate(t *testing.T) {
	t.Skip("Resource Device does not support empty tags")
...
func TestAccNetworkManagerDevice_tags_EmptyTag_OnUpdate_Add(t *testing.T) {
	t.Skip("Resource Device does not support empty tags")
...
func TestAccNetworkManagerDevice_tags_EmptyTag_OnUpdate_Replace(t *testing.T) {
	t.Skip("Resource Device does not support empty tags")
...
func TestAccNetworkManagerDevice_tags_DefaultTags_providerOnly(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
				ConfigDirectory:          config.StaticDirectory("testdata/Device/tags_defaults/"),
				ConfigVariables: config.Variables{
...
func TestAccNetworkManagerDevice_tags_DefaultTags_nonOverlapping(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccNetworkManagerDevice_tags_DefaultTags_overlapping(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccNetworkManagerDevice_tags_DefaultTags_updateToProviderOnly(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccNetworkManagerDevice_tags_DefaultTags_updateToResourceOnly(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccNetworkManagerDevice_tags_DefaultTags_emptyResourceTag(t *testing.T) {
	t.Skip("Resource Device does not support empty tags")
...
func TestAccNetworkManagerDevice_tags_DefaultTags_emptyProviderOnlyTag(t *testing.T) {
	t.Skip("Resource Device does not support empty tags")
...
func TestAccNetworkManagerDevice_tags_DefaultTags_nullOverlappingResourceTag(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccNetworkManagerDevice_tags_DefaultTags_nullNonOverlappingResourceTag(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccNetworkManagerDevice_tags_ComputedTag_OnCreate(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
				ConfigDirectory:          config.StaticDirectory("testdata/Device/tagsComputed1/"),
				ConfigVariables: config.Variables{
...
func TestAccNetworkManagerDevice_tags_ComputedTag_OnUpdate_Add(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
				ConfigDirectory:          config.StaticDirectory("testdata/Device/tagsComputed2/"),
				ConfigVariables: config.Variables{
					"unknownTagKey": config.StringVariable("computedkey1"),
...
func TestAccNetworkManagerDevice_tags_ComputedTag_OnUpdate_Replace(t *testing.T) {
	ctx := acctest.Context(t)
...
func TestAccNetworkManagerDevice_tags_IgnoreTags_Overlap_DefaultTag(t *testing.T) {
	ctx := acctest.Context(t)
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ProtoV5ProviderFactories: acctest.ProtoV5ProviderFactories,
				ConfigDirectory:          config.StaticDirectory("testdata/Device/tags_ignore/"),
				ConfigVariables: config.Variables{
					acctest.CtProviderTags: config.MapVariable(map[string]config.Variable{
						acctest.CtProviderKey1: config.StringVariable(acctest.CtProviderValue1),
					}),
...
func TestAccNetworkManagerDevice_tags_IgnoreTags_Overlap_ResourceTag(t *testing.T) {
	ctx := acctest.Context(t)
