...
func TestFullTypeName_type(t *testing.T) {
	...
	expected := "github.com/blampe/patches/mirrors/aws/v6/internal/framework/flex.emptyStruct"
...
func TestFullTypeName_mapTypedKeyPrimitiveValue(t *testing.T) {
	...
	expected := "map[github.com/blampe/patches/mirrors/aws/v6/internal/framework/flex.testEnum]string"
...
func TestFullTypeName_mapPrimitiveKeyTypedValue(t *testing.T) {
	...
	expected := "map[string]github.com/blampe/patches/mirrors/aws/v6/internal/framework/flex.testEnum"
