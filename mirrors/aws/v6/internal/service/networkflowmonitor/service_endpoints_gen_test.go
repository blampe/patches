...
const (
	packageName = "networkflowmonitor"
	awsEnvVar   = "AWS_ENDPOINT_URL_NETWORKFLOWMONITOR"
	baseEnvVar  = "AWS_ENDPOINT_URL"
	configParam = "networkflowmonitor"
)
...
func defaultEndpoint(ctx context.Context, region string) (url.URL, error) {
	r := networkflowmonitor.NewDefaultEndpointResolverV2()

	ep, err := r.ResolveEndpoint(ctx, networkflowmonitor.EndpointParameters{
