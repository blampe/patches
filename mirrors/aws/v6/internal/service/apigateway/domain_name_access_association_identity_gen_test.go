...
func TestAccAPIGatewayDomainNameAccessAssociation_Identity_RegionOverride(t *testing.T) {
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Step 1: Setup
			{
				ConfigDirectory: config.StaticDirectory("testdata/DomainNameAccessAssociation/region_override/"),
				ConfigVariables: config.Variables{
					acctest.CtRName:          config.StringVariable(rName),
					acctest.CtCertificatePEM: config.StringVariable(certificatePEM),
					acctest.CtPrivateKeyPEM:  config.StringVariable(privateKeyPEM),
...
func TestAccAPIGatewayDomainNameAccessAssociation_Identity_ExistingResource(t *testing.T) {
	...
	acctest.ParallelTest(ctx, t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ConfigDirectory: config.StaticDirectory("testdata/DomainNameAccessAssociation/basic_v6.0.0/"),
				ConfigVariables: config.Variables{
					acctest.CtRName:          config.StringVariable(rName),
					acctest.CtCertificatePEM: config.StringVariable(certificatePEM),
					acctest.CtPrivateKeyPEM:  config.StringVariable(privateKeyPEM),
