...
import (
	...
	tfconfig "github.com/blampe/patches/mirrors/aws/v5/internal/service/configservice"
...
func TestAccConfigServiceConfigurationAggregator_account(t *testing.T) {
	...
	//Name is upper case on purpose to test https://github.com/blampe/patches/mirrors/aws/v5/issues/8432
